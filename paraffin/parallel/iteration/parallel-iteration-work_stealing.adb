...
procedure Parallel.Iteration.Work_Stealing
...
is
   ...
   begin
         ...
         pragma Debug
           (Debug_Logging, Put_Line
              ("Calling Process, First=" &
               Work_Stealing_Loop_Index'Image
         ...
         if Worker_Progress (Work_Id).Last_Index.Value
           /= Previous_Last_Index then
              ...
              (Debug_Logging,
               Put_Line
                 ("Worker " &
                    ...
                    " Offering Work: Start=" &
                    Work_Stealing_Loop_Index'Image
                      (Work_Stealing_Loop_Index'Succ
                        (Worker_Progress (Work_Id).Last_Index.Value)) &
                    ", Finish=" &
                    Work_Stealing_Loop_Index'Image (Previous_Last_Index)));
            ...
            pragma Debug
              (Debug_Logging,
               Put_Line
                 ("Stealing=" & Effective_Worker_Id'Image (Work_Id)));
      ...
      pragma Debug
        (Debug_Logging,
         Put_Line (Effective_Worker_Id'Image (Work_Id) & "Exiting"));
...
end Parallel.Iteration.Work_Stealing;
