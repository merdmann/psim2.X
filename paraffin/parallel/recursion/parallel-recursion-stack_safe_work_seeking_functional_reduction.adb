...
package body Parallel.Recursion.Stack_Safe_Work_Seeking_Functional_Reduction is
   function Execute
     (Item            : Work_Type;
      ...
      Stack_Deferrals : access Stack_Limit_Count) return Result_Type
   is
      ...
      protected body Work_Seeker is
         ...
         begin
            if All_Work_Complete then
               ...
               --  Wait_For_Later_Offer
               --  Shuts down other queued tasks, or if they all get moved to
               --  Wait_For_Work
               Other_Workers.all :=
      ...
      begin
         ...
         if Other_Workers.Seeking_Work then
            ...
            Stack_Deferrals.all := Stack_Deferrals.all + 1;
   ...
   begin -- Elementary_Stack_Limited_Work_Seeking_Reducing_Recurse

      Stack_Deferrals.all := 0;
