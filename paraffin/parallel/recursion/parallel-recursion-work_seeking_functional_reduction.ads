...
package Parallel.Recursion.Work_Seeking_Functional_Reduction is
   ...
   function Execute
     (Item : Work_Type;
      ...
      --  Client supplied recursion routine that should check
...
end Parallel.Recursion.Work_Seeking_Functional_Reduction;
