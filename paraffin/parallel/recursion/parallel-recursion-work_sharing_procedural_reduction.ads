...
--  recursion, using a work-sharing approach that produces a result for
--  as an out parameter of a procedure call.
...
package Parallel.Recursion.Work_Sharing_Procedural_Reduction is
