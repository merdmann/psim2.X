...
package body Parallel.Recursion.Stack_Safe_Work_Seeking_Procedural_Reduction is
   ...
   is
      ...
      protected body Work_Seeker is
         ...
         begin
            if All_Work_Complete then
               ...
               --  Either we are here because a worker made a work offer,
               --  or some work was deferred. (But not both)
         ...
         entry Wait_For_Deferred
           (Item        : out Work_Type;
            Work_Budget : in out Work_Budget_Limit;
            Done        : out Boolean) when Deferred_Length > 0
                                           or else All_Work_Complete
         is
         begin
            if All_Work_Complete then
               Done := True;
         ...
         entry Wait_For_Worker_Initialization when Wait_For_Work'Count +
                                                   Wait_For_Later_Offer'Count =
                                                   Worker_Count is
         begin
            null;
      ...
      task body Worker is
         Value : Work_Type;
         Temp  : Result_Type := Identity_Value;
         Done  : Boolean     := False;
      ...
      begin -- Worker
         ...
         if Use_Affinity then
            ...
            begin
               ...
               Worker_Affinity (((CPU_Id_Type'Base (Work_Id) - 1) rem
                                 Available_CPUs) +
                                1) := True;
         ...
         Work_Loop : loop
            ...
            Reducer (Left => Results (Work_Id), Right => Temp);
         end loop Work_Loop;
      ...
      procedure Initial_Recurse (Item : Work_Type) is
   ...
   begin -- Composite_Work_Seeking_Reducing_Recurse
...
end Parallel.Recursion.Stack_Safe_Work_Seeking_Procedural_Reduction;
