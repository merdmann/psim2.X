...
with Parallel.Recursion.Stack_Safe_Work_Seeking;
...
package body Stack_Safe_Work_Seeking_Red_Black_Trees is
   ...
   package Red_Black_Tree_Recursion is new
     Parallel.Recursion.Stack_Safe_Work_Seeking (Work_Type => Node_Access);
   ...
   is
      ...
      Deferral_Count : Parallel.Recursion.Stack_Limit_Count;
      ...
      begin
         ...
         if Other_Workers.Seeking_Work then
            Dispatcher.Recurse (Item    => Node.Left,
                       Stack_Limit => Stack_Limit);
            Span_Tree (Node.Right,
                         Stack_Limit => Stack_Limit);
            Free_Node (Writeable_Node.all);
         elsif Node'Address <= Stack_Limit then
   ...
   begin
      ...
      pragma Warnings (Off, "*Deferral_Count*modified*but*never referenced*");
      Red_Black_Tree_Recursion.Execute
        (Item             => Container.Root,
         ...
         Stack_Deferrals  => Deferral_Count);

      pragma Warnings (On, "*Deferral_Count*modified*but*never referenced*");
   ...
   is
      ...
      begin
         ...
         if Node = null then
         ...
         elsif Other_Workers.Seeking_Work then
            declare
               Temp : Result_Type;
            begin
               Dispatcher.Recurse
               ...
               Span_Tree (Node.Right, Stack_Limit, Temp);
            ...
            declare
               Temp : Result_Type;
            begin
               Span_Tree (Node.Left, Stack_Limit, Result);
   ...
   is
      ...
      package Red_Black_Tree_Recursion is
        new Stack_Safe_Work_Seeking_Functional_Reduction
          (Work_Type => Node_Access,
           Result_Type => Result_Type,
           Reducer => Reducer,
           Identity_Value => Identity_Value);
      ...
      begin
         ...
         if Other_Workers.Seeking_Work then
              ...
              Reducer
                (Left => Reducer
                     (Left => Dispatcher.Recurse
                      ...
                      Right => Process
                        (Cursor'(Container'Unrestricted_Access, Node))),
                 Right => Span_Tree (Node.Right, Stack_Limit));
            ...
            return
              Reducer
                (Left => Reducer
                     (Left => Span_Tree (Node.Left, Stack_Limit),
                      Right => Process
                        (Cursor'(Container'Unrestricted_Access, Node))),
                 Right => Span_Tree (Node.Right, Stack_Limit));
         end if;
   ...
   is
      ...
      begin
         ...
         if Other_Workers.Seeking_Work then
            ...
            Span_Tree (Node.Right, Stack_Limit);
            ...
            Span_Tree (Node.Left, Stack_Limit);
            Process (Cursor'(Container'Unrestricted_Access, Node));
            Span_Tree (Node.Right, Stack_Limit);
         end if;
