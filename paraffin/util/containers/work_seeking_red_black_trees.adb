...
package body Work_Seeking_Red_Black_Trees is
   ...
   package Red_Black_Tree_Recursion is new
     Parallel.Recursion.Work_Seeking (Work_Type => Node_Access);
   ...
   is
      ...
      procedure Span_Tree (Node : Node_Access)
      is
   ...
   is
      ...
      package Red_Black_Tree_Recursion is new Work_Seeking_Procedural_Reduction
   ...
   is
      ...
      package Red_Black_Tree_Recursion is new Work_Seeking_Functional_Reduction
        (Work_Type => Node_Access,
         Result_Type => Result_Type,
         Reducer => Reducer,
         Identity_Value => Identity_Value);
      ...
      function Span_Tree (Node : Node_Access) return Result_Type is
      begin
         ...
         if Other_Workers.Seeking_Work then
            ...
            return
              Reducer
                (Left => Reducer
                     (Left => Dispatcher.Recurse (Item => Node.Left),
                      Right => Process
                        (Cursor'(Container'Unrestricted_Access, Node))),
   ...
   is
      ...
      begin
         ...
         if Other_Workers.Seeking_Work then
            Dispatcher.Recurse (Item    => Node.Right);
            Process (Cursor'(Container'Unrestricted_Access, Node));
            Span_Tree (Node.Left);
         else
            Span_Tree (Node.Right);
...
end Work_Seeking_Red_Black_Trees;
