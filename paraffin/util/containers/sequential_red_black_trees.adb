...
--                                                                          --
--             R E C U R S I V E _ B I N A R Y _ T R E E               --
--                                                                          --
--                                B o d y                                   --
--                                                                          --
...
package body Sequential_Red_Black_Trees is
   ...
   begin
      Span_Tree (Node => Container.Root, Result => Result);
   ...
   begin
      return Reducer (Left => Initial_Value,
                      Right => Span_Tree (Node => Container.Root));
...
end Sequential_Red_Black_Trees;
